...
<div class="session session-plenary"><span class="session-title">Land Acknowledgment, Opening Remarks and Janyce Wiebe and Richard Kittredge Remembrances&nbsp;<i class="fa fa-file-pdf-o paper-icon" data="https://naacl2019.org/downloads/naacl2019-intro-slides.pdf" aria-hidden="true" title="PDF"></i></span><br/><span class="session-time" title="Monday, June 03, 2019">9:00 &ndash; 9:30</span><br/><span class="session-location btn btn--location">Nicollet Ballroom</span></div>
