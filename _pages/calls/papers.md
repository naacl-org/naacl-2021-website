...
As in recent years, some of the presentations at the conference will be of papers accepted by the [Transactions of the ACL](http://www.transacl.org). In addition, please consult the separate CFP for [industry track submissions](/calls/industry). Separate CFPs will be forthcoming for submissions for system demonstrations and student research workshop papers. 
